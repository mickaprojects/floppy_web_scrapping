...
if os.path.exists("recup_liste_vacance.lock")==False:
    try:
        lock=open("recup_liste_vacance.lock", "a")
        lock.close()
        k = 0

        #31 12 2018 python27
        trace = open("trace_recup_liste_vacance.txt", "w")
        trace.close()
        ...
        if (os.access(nom_parametre, os.F_OK) == False):
            trace = open("trace_recup_liste_vacance.txt", "a")
        ...
        #     # if x in [1,2]:
        #     liste_option.append(u""+options_element[x].get_attribute("value"))
        ...
        element_rechercher=driver.find_element_by_xpath("//td[@class='btn-rechercher']/a")
        ...
        while True:
            ...
            try:
                ...
                # if page1=="3":
                #     # current_url=href
                #     # url_suivant=current_url.replace("?page=3", "?page=16")
        ...
        if os.path.exists('recup_liste_vacance.lock')==True:
            os.remove('recup_liste_vacance.lock')
